...
from ot_aiops.ops._shared import num, s
...
def _read_point(target: Any, ref: str) -> tuple[Any, str]:
    ...
    if protocol == "opcua":
        from ot_aiops.ops.opcua_ops import read_node
