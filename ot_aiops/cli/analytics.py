"""``ot-aiops analytics ...`` — OEE / downtime / asset-inventory (read-only).
...
from ot_aiops.cli._common import cli_errors, get_manager
from ot_aiops.ops import asset_inventory as asset
