...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "decode), and EtherNet/IP (Rockwell/Allen-Bradley Logix tags); EtherCAT is "
        "a documented roadmap stub. Call protocols_supported() for the capability "
        ...
        "mc_write_words, mqtt_publish, eip_write_tag) are OT-dangerous: governed at "
        "HIGH risk_tier, off by default (dry-run), capture the BEFORE value for "
        "undo, and need a recorded approver (MOC). "
