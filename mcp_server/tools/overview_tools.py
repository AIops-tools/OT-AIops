...
def protocols_supported() -> dict:
    ...
    Lists implemented protocols (OPC-UA, Modbus, S7comm, Mitsubishi MC, MTConnect,
    MQTT/Sparkplug B) and roadmap stubs (EtherNet/IP, EtherCAT), each with its
    read/write tools and the endpoint params it needs.

    Returns dict: {tool, posture, implemented_protocols:[...], roadmap_stubs:[...],
        protocols:[{protocol, status, library, transport, auth, read_tools,
        write_tools, params}], diagnostics:[...], tool_counts, safety}.
